...
impl Middleware {
    ...
    pub fn syncback<'sync>(
        ...
        match self {
            ...
            Middleware::LegacyServerScript => syncback_lua(snapshot),
            Middleware::LegacyClientScript => syncback_lua(snapshot),
            Middleware::RunContextServerScript => syncback_lua(snapshot),
            Middleware::RunContextClientScript => syncback_lua(snapshot),
